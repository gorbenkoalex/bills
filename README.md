...
> буде недоступним. Щоб уникнути попереджень у консолі, додайте ці файли у `dist/` вручну або виконайте `npm install`, який
> завантажить pdf.js і скопіює потрібні збірки під час `npm run build`.
